...
class AdminPermissionSeeder extends Seeder
{
    ...
    public function run()
    {
        //cannot truncate a table referenced in a foreign key constrains
        //disable foreign key checking (permission_role table), avoid removed current role_pemission data
        DB::statement("
        ...
        DB::table('permission')->insert([
            'id' => 123,
            'permission_group' => 'Report',
            'display_sorting' => 91.320,
            'permission_name' => 'credittransfer',
            'display_name' => 'View Credit Transfer',
            'description' => 'Allow admin user to view Credit Transfer',
            'created_at' => date('Y-m-d H:i:s'),
            'updated_at' => date('Y-m-d H:i:s')
        ]);
        ...
        DB::table('permission')->insert([
            'id' => 124,
            'permission_group' => 'Report',
            'display_sorting' => 91.321,
            'permission_name' => 'exportcredittransfer',
            'display_name' => 'Export Credit Transfer',
            'description' => 'Allow admin user to export Credit Transfer',
            'created_at' => date('Y-m-d H:i:s'),
            'updated_at' => date('Y-m-d H:i:s')
        ]);
        ...
        DB::table('permission')->insert([
            'id' => 125,
            'permission_group' => 'Lucky Draw',
            'display_sorting' => 100.000,
            'permission_name' => 'luckydraw',
            'display_name' => 'Luck Draw',
            'description' => 'Allow admin user to view Lucky Draw',
            'created_at' => date('Y-m-d H:i:s'),
            'updated_at' => date('Y-m-d H:i:s')
        ]);
        ...
        DB::table('permission')->insert([
            'id' => 126,
            'permission_group' => 'Merchants',
            'display_sorting' => 71.901,
            'permission_name' => 'merchantupdateguarantor',
            'display_name' => 'Edit Merchant Guarantor',
            'description' => 'Allow admin user to update merchant guarantor info',
            'created_at' => date('Y-m-d H:i:s'),
            'updated_at' => date('Y-m-d H:i:s')
        ]);
        ...
        DB::table('permission')->insert([
            'id' => 127,
            'permission_group' => 'Merchants',
            'display_sorting' => 71.902,
            'permission_name' => 'merchantupdatereferrer',
            'display_name' => 'Edit Merchant Referrer',
            'description' => 'Allow admin user to update merchant referrer',
            'created_at' => date('Y-m-d H:i:s'),
            'updated_at' => date('Y-m-d H:i:s')
        ]);
        ...
        DB::table('permission')->insert([
            'id' => 128,
            'permission_group' => 'Merchants',
            'display_sorting' => 71.903,
            'permission_name' => 'merchantlistingexport',
            'display_name' => 'Export Merchant Listing',
            'description' => 'Allow admin user to export merchant listing',
            'created_at' => date('Y-m-d H:i:s'),
            'updated_at' => date('Y-m-d H:i:s')
        ]);
