...
class SpGetYearlySaleReportByDate extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        DB::unprepared("
			CREATE PROCEDURE `sp_get_yearly_sale_report_by_date`(
			...
			BEGIN
				...
				SELECT * FROM 
					...
					and FIND_IN_SET(`nm_merchant`.`mer_co_id`, merchant_country_list)
					and FIND_IN_SET(`nm_store`.`stor_country`, store_country_list)
					group by `l2_year`, `l2_merchant_country_id` ) as table2

					ON (table1.l1_year = table2.l2_year)
					...
					and FIND_IN_SET(`nm_merchant`.`mer_co_id`, merchant_country_list)
					and FIND_IN_SET(`nm_store`.`stor_country`, store_country_list)
					group by `l3_year`, `l3_merchant_country_id`, `l3_merchant_id`  ) as table3

					ON (table2.l2_year = table3.l3_year AND table2.l2_merchant_country_id = table3.l3_merchant_country_id)
					...
					and FIND_IN_SET(`nm_merchant`.`mer_co_id`, merchant_country_list)
					and FIND_IN_SET(`nm_store`.`stor_country`, store_country_list)
					group by `l4_year`, `l4_merchant_country_id`, `l4_merchant_id`, `l4_store_id`  ) as table4

					ON (table3.l3_year = table4.l4_year AND  table3.l3_merchant_country_id = table4.l4_merchant_country_id AND table3.l3_merchant_id = table4.l4_merchant_id)
					...
					`l1_year`, `l1_merchant_country_id`, `l1_merchant_id`, `l1_store_id`,
					`l2_year`, `l2_merchant_country_id`, `l2_merchant_id`, `l2_store_id`,
					`l3_year`, `l3_merchant_country_id`, `l3_merchant_id`, `l3_store_id`,
					`l4_year`, `l4_merchant_country_id`, `l4_merchant_id`, `l4_store_id` ASC
