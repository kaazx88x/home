...
class SpGetYearlyCreditReport extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        DB::unprepared("
			CREATE PROCEDURE `sp_get_yearly_credit_report`(
			...
			BEGIN
				...
				GROUP BY l1_year, l1_user_type, l1_credit_type ) as table1
				...
				AND credit_type = credit_type_input
				AND FIND_IN_SET(`report_monthly_credit`.`country_id`, country_list)
				GROUP BY l2_year, l2_user_type, l2_credit_type, l2_country_id ) as table2
