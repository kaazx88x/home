                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            <td align="left" style="padding: 20px 0 0 0; font-size: 16px; line-height: 25px; font-family: Helvetica, Arial, sans-serif; color: #666666;" class="padding-copy">
                                ...
                                <br>
                                @lang('email.member.account_activation.msg2')
                            </td>
                        </tr>
                        <tr>
                            <td align="center">
                                    ...
                                    <tr>
                                        <td align="center" style="padding-top: 25px;" class="padding">
                                            <table border="0" cellspacing="0" cellpadding="0" class="mobile-button-container">
                                                <tr>
                                                    <td align="center">
                                                        <span style="font-size: 16px; font-family: Helvetica, Arial, sans-serif; color: #ffffff; text-decoration: none; color: #000; text-decoration: none; border-radius: 3px; padding: 15px 25px; display: inline-block;">Email : {{$email}}</span>
                                                    </td>
                                                </tr>
