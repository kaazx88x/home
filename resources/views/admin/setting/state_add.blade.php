...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-sm-4">
        <h2>{{trans('localize.Create_New_State')}}</h2>
        <ol class="breadcrumb">
            <li>
                <a href="/admin">{{trans('localize.dashboard')}}</a>
            </li>
            <li>
                <a href="/admin/setting/state/{{$country->co_id}}">{{trans('localize.state')}}</a>
            </li>
            <li class="active">
        ...
        <div class="col-lg-6">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <form id='form' class="form-horizontal" action='/admin/setting/state/add/{{$country->co_id}}' method="POST">
                        {{ csrf_field() }}
