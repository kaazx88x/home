...
@section('title', 'Create Filter Item')

@section('content')
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-sm-4">
        <h2>{{trans('localize.Create_New_Item')}}</h2>
        <ol class="breadcrumb">
            <li>
        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <form id='form' class="form-horizontal" action='/admin/setting/filter/item/add/{{ $parent->id }}' method="POST">
                        {{ csrf_field() }}

                        <div class="form-group">
                            <label class="col-lg-2 control-label">{{trans('localize.Filter')}}</label>
                            <div class="col-lg-10">
