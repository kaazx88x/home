...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-sm-4">
        <h2>{{trans('localize.Edit')}} {{trans('localize.Filter')}}</h2>
        <ol class="breadcrumb">
            <li>
        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <form id='form' class="form-horizontal" action='/admin/setting/filter/edit/{{$filter->id}}' method="POST">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <input type="text" placeholder="{{trans('localize.Description')}}" class="form-control" name="description" value='{{ $filter->description }}'>
                            </div>
                        </div>
