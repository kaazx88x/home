        ...
        <div class="col-lg-6">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <form class="form-horizontal" action='/admin/setting/city/add' method="POST">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <input type="text" placeholder="City Name" class="form-control" name='name' required="required" value='{{old('name')}}'>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-lg-2 control-label">Latitude</label>
                            <div class="col-lg-10">
                                <input type="text" placeholder="Latitude" class="form-control" name='lat' required="required" value='{{old('lat')}}'>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-lg-2 control-label">Longitude</label>
                            <div class="col-lg-10">
                                <input type="text" placeholder="Longitude" class="form-control" name='long' required="required" value='{{old('long')}}'>
                            </div>
                        </div>
                        <div class="form-group">
