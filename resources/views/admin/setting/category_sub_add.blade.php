...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-sm-12">
        ...
        <ol class="breadcrumb">
            ...
            <li>
                <a href="/admin/setting/category/main/{{$maincategory->smc_mc_id}}">Main Category</a>
            </li>
            <li>
                <a href="/admin/setting/category/sub/{{$maincategory->smc_id}}">Sub Category</a>
            </li>
            <li class="active">
        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <form class="form-horizontal" action='/admin/setting/category/sub/add/{{$maincategory->smc_id}}' method="POST">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            <div class="col-lg-offset-2 col-lg-10">
                                <input type="hidden" name="category_id" value="{{$maincategory->smc_mc_id}}">
                                <input type="hidden" name="maincategory_id" value="{{$maincategory->smc_id}}">
