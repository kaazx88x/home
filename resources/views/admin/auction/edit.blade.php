...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-sm-4">
        <h2>Edit Auction Product</h2>
        <ol class="breadcrumb">
            <li>
                Auction
            </li>
            <li class="active">
                <strong>Edit Auction</strong>
            </li>
        </ol>
    </div>
</div>
        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <form class="form-horizontal" id="edit_auction" action='/admin/auction/edit' method="POST" enctype="multipart/form-data">
                         {{ csrf_field() }}
                             ...
                             <div class="col-lg-10">
                                 <select class="form-control" id="mer_id" name="mer_id" >
                                         ...
                                         @foreach ($merchants as $merchant)
                                             <option value="{{$merchant->mer_id}}" {{ ($auction['merchant']->mer_id == $merchant->mer_id)? 'selected' :  '' }}>{{$merchant->mer_fname}}</option>
                                         @endforeach
                                </select>
                             </div>
                         </div>
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <select class="form-control" name="pro_type">
                                    <option value="normal_product" {{ ($auction['details']->auc_product_type == 'normal_product')? 'selected' :  '' }}>Normal Product</option>
                                    <option value="rookie_product" {{ ($auction['details']->auc_product_type == 'rookie_product')? 'selected' :  '' }}>Rookie Product</option>
                                    <option value="demo_product" {{ ($auction['details']->auc_product_type == 'demo_product')? 'selected' :  '' }}>Demo Product</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <select class="form-control" name="status">
                                    <option value="1" {{ ($auction['details']->auc_status == 1 )? 'selected' :  '' }}>Active</option>
                                    <option value="0" {{ ($auction['details']->auc_status == 0 )? 'selected' :  '' }}>Inactive</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <input type="text" placeholder="Product Title (English)" class="form-control" id="pro_title_en" name='pro_title_en' value="{{ $auction['details']->auc_title_en }}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-lg-2 control-label">Title (Chinese)</label>
                            <div class="col-lg-10">
                                <input type="text" placeholder="Product Title (Chinese)" class="form-control" name='pro_title_cn' value="{{ $auction['details']->auc_title_cn }}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-lg-2 control-label">Title (Bahasa)</label>
                            <div class="col-lg-10">
                                <input type="text" placeholder="Product Title (Bahasa)" class="form-control" name='pro_title_my' value="{{ $auction['details']->auc_title_my }}">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <select class="form-control" id="pro_category" name="pro_category">
                                    ...
                                    @foreach ($categories as $category)
                                        <option value="{{$category->mc_id}}" {{ ($category->mc_id == $auction['details']->auc_category)? 'selected' : ''}}>{{$category->mc_name_en}}</option>
                                    @endforeach
                               </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <input type="number"  placeholder="Numbers Only" class="form-control" id='original_price' name='original_price' value="{{ $auction['details']->auc_original_price }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <input type="number"  placeholder="Numbers Only" class="form-control" id='auction_price' name='auction_price' value="{{ $auction['details']->auc_auction_price }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <input type="number"  placeholder="Numbers Only" class="form-control" id='game_point' name='game_point' value="{{ $auction['details']->auc_game_point }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <input type="number"  placeholder="Numbers Only" class="form-control" id='maxbid' name='maxbid' value="{{ $auction['details']->auc_total_bids }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <input type="number"  placeholder="Numbers Only" class="form-control" id='bot_maxbid' name='bot_maxbid' value="{{ $auction['details']->auc_bot_target }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                ...
                                <input type="hidden" name="start" id="start" value="{{$auction['details']->auc_start_date}}">
                                <input type="hidden" name="end" id="end" value="{{$auction['details']->auc_end_date}}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <textarea class="form-control" rows="5" style="resize: none;" name="shipping_info">{!! $auction['details']->auc_shippinginfo !!}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <textarea id="desc_en" placeholder="Description in English" class="form-control"  id='pro_desc_en' name='pro_desc_en'>{!! $auction['details']->auc_description_en !!}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-lg-2 control-label">Description (Chinese)</label>
                            <div class="col-lg-10">
                                <textarea id="desc_cn" placeholder="Description in Chinese" class="form-control" name='pro_desc_cn'>{!! $auction['details']->auc_description_cn !!}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-lg-2 control-label">Description (Bahasa)</label>
                            <div class="col-lg-10">
                                <textarea id="desc_my" placeholder="Description in Bahasa" class="form-control" name='pro_desc_my'>{!! $auction['details']->auc_description_my !!}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <input type="text" class="form-control" placeholder="Enter meta keyword" name='metakeyword' value="{{ $auction['details']->auc_meta_keyword }}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-lg-2 control-label">Meta Description</label>
                            <div class="col-lg-10">
                                <input type="text" class="form-control" placeholder="Enter meta description" name='metadescription' value="{{ $auction['details']->auc_meta_description }}">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-10" id="img_upload">
                                <?php
                                    ...
                                    $path = env('IMAGE_DIR').'/auction/'.$auction['details']->auc_merchant_id.'/';
                                ?>
                                @foreach ($images as $key => $image)
                                    <input type="hidden" name="file_old[]" value="{{$image}}" >
                                    <div class="row" id="row{{ $key }}">
                                        <div class="col-xs-3 col-md-2">
                                            <img src="{{$path.$image}}" height="50" width="50">
                                        </div>
                                        <div class="col-xs-9 col-md-10">
                                            <span class="btn btn-default"><input type='file' id='file{{ $key }}' name='file[]'/></span>
                                            @if ($key > 0)
                                                <a class="btn btn-md btn-danger" id="delImg" onclick="removeDiv('#row{{ $key }}'); return false;">Delete</a>
                                            @endif
                                            <br/>
                                            <small>Or choose image to replace.</small>
                                        </div>
                                        @if ($key < 1)
                                ...
                                <input type="hidden" id="count" name="count" value="{{$count_images}}">
                            </div>
                        </div>

                        <input type="hidden" name="auc_id" value="{{ $auction['details']->auc_id }}">
                        ...
                        <div class="form-group">
                            <div class="col-lg-2 pull-right">
                                <button class="btn btn-block btn-primary" id="submit">Edit Auction</button>
                            </div>
                        </div>
                    </form>
                </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        load_merchant_store('#stor_id', {{ ($auction['merchant']->mer_id)? $auction['merchant']->mer_id :  '' }}, {{ ($auction['details']->auc_shop_id)? $auction['details']->auc_shop_id :  '' }} );

         // Load Category selected
        var category = {{($auction['details']->auc_category) ? $auction['details']->auc_category : 0}};
        var maincategory = {{($auction['details']->auc_main_category) ? $auction['details']->auc_main_category : 0}};
        var subcategory = {{($auction['details']->auc_sub_category) ? $auction['details']->auc_sub_category : 0}};
        var secsubcategory = {{($auction['details']->auc_second_sub_category) ? $auction['details']->auc_second_sub_category : 0}};

        load_maincategory('#pro_maincategory', category, maincategory);
        load_subcategory('#pro_subcategory', maincategory, subcategory);
        load_secsubcategory('#pro_secsubcategory', subcategory, secsubcategory);
        ...
        $('input[name="daterange"]').daterangepicker({
            ...
            startDate : "{{$auction['details']->auc_start_date}}",
            endDate : "{{$auction['details']->auc_end_date}}",
            locale: {
