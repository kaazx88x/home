...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-sm-4">
        <h2>{{trans('localize.Add_New_Product')}}</h2>
        <ol class="breadcrumb">
            <li>
                ...
                <div class="tab-content">
                    <div id="tab-1" class="tab-pane active">
                        <div class="panel-body">
                            ...
                            <form id="add_product" action='/admin/product/add' method="POST" enctype="multipart/form-data">
                            {{ csrf_field() }}
                                        ...
                                        <div class="panel panel-default">
                                            ...
                                            <div class="panel-body">
                                                <div class="form-group">
                                                    <label class="control-label">{{trans('localize.Merchants')}} <span style="color:red;">*</span></label>
                                                    <select class="form-control compulsary" id="mer_id" name="mer_id" >
                                                        <option value="">-- {{trans('localize.Select_Merchant')}} --</option>
                                                        @foreach ($merchants as $merchant)
                                                            <option value="{{$merchant->mer_id}}" {{ (old('mer_id', 0) == $merchant->mer_id)? 'selected' : '' }}> {{ $merchant->mer_id . ' - '. $merchant->mer_fname . ' ' . $merchant->mer_lname }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control compulsary" id="stor_id" name="stor_id" >
                                                        <option value="">-- {{trans('localize.Please_Select_Merchant_First')}} --</option>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" placeholder="{{trans('localize.product_tittle_english')}}" class="form-control compulsary" id="pro_title_en" name='pro_title_en' value="{{ old('pro_title_en') }}">
                                                </div>

                                                <div class="form-group">
                                                    <label class="control-label">{{trans('localize.product_tittle_chinese')}}</label>
                                                    <input type="text" placeholder="{{trans('localize.product_tittle_chinese')}}" class="form-control" name='pro_title_cn' value="{{ old('pro_title_cn') }}">
                                                </div>

                                                <div class="form-group">
                                                    <label class="control-label">{{trans('localize.product_tittle_chinese_traditional')}}</label>
                                                    <input type="text" placeholder="{{trans('localize.product_tittle_chinese_traditional')}}" class="form-control" name='pro_title_cnt' value="{{ old('pro_title_cnt') }}">
                                                </div>

                                                <div class="form-group">
                                                    <label class="control-label">{{trans('localize.product_tittle_bahasa')}}</label>
                                                    <input type="text" placeholder="{{trans('localize.product_tittle_bahasa')}}" class="form-control" name='pro_title_my' value="{{ old('pro_title_my') }}">
                                                </div>
                                            </div>
                                        ...
                                        <div class="panel panel-default">
                                            <div class="panel-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea rows="8" class="form-control text-noresize" placeholder="{{trans('localize.mer_meta_description')}}" name='metadescription' id='metadescription'>{{ old('metadescription') }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div id="tab-2" class="tab-pane">
                        <div class="panel-body">
                            <span class="text-navy"><strong>@lang('localize.this_section_will_be_available_after_product_is_created')</strong></span>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
                ...
                if ($(this).hasClass('compulsary')) {
                    ...
                    if($(this).attr('id') === 'selected_cats') {
                        if(JSON.parse($(this).val()).length == 0) {
                            swal("@lang('localize.swal_error')", "{{trans('localize.select_category_to_proceed')}}", "error");
                            event.preventDefault();
                            return false;
                        }
                    }
    ...
    $(function() {
        load_merchant_store('#stor_id', {{ old('mer_id', '0') }}, {{ old('stor_id', '0') }});
    });
</script>
@endsection
