...
<div class="container">
    ...
    <div class="row">
        <table style="width: 100%">
            <tr>
                ...
                <td style="text-align: center;"><h2 style="font-family: 'Times New Roman', Times, serif;letter-spacing: 2px;"><b>{{ env('COMPANY_NAME') }}</b><span style="font-size:12px;font-weight:normal"> ({{ env('COMPANY_REG_NO') }})</span></h2>(@lang('localize.gst_id_no') :  {{ env('GST') }})<br>{!! env('COMPANY_ADDRESS') !!} <br> @lang('localize.tel') : {{ env('CONTACT_NO') }}</td>
            </tr>
        </table>
    </div>
    <hr/>
    <div class="row">
        <div class="col-xs-12">
            <h2 class="text-uppercase;" style="text-align:center;font-family: 'Verdana',sans-serif;text-transform: uppercase;">@lang('localize.tax_invoice')</h2>
        </div>
    </div>
    <br>
    <br>
                ...
                <tr>
                    ...
                    <td style="margin-top:5%;width:28.5%;margin-left:20.5%">
                        <div style="border:1px solid black">
                            <br>
                            <b style="padding-left:10px">@lang('localize.invoice_no')  :</b> OFC{{ $order->tax_inv_no }}<br>
                            <b style="padding-left:10px">@lang('localize.date')        :</b>{{ date_format($order->created_at, 'd/m/Y') }}<br>
                            <b style="padding-left:10px">@lang('localize.Page')        :</b>1<br>
                            <br>
                        <div>
                    </td>
                </tr>
    ...
    <div class="row">
        <div class="col-xs-12">
            <table width="100%" style="border: 1px solid;border-collapse: collapse;">
                ...
                <tr>
                    <th colspan="3" style="padding-left:5px;border: 1px solid;font-weight: normal">{{ trans('localize.offline_commission') }}</td>
                    <td colspan="2" class="text-center" style="border: 1px solid;border: 1px solid;text-align:center;font-weight: normal">{{ number_format($total, 2) }}</td>
                </tr>
                <tr>
                    <th colspan='3' style="border: 1px solid;">&nbsp;</th>
                    <td class='text-center' colspan="2" style="border: 1px solid;"></td>
                ...
                <tr>
                <th colspan='3' style="padding-left:5px;border: 1px solid;font-weight: normal">@lang('localize.merchant_invoice_no') : {{$order->inv_no}}</th>
                    <td class='text-center' colspan="2" style="border: 1px solid;"></td>
                </tr>
                <tr>
                    <th colspan='3' style="border: 1px solid;">&nbsp;</th>
            ...
            <table width="80%">
                ...
                <tr>
                    <th style="padding-left:5px;text-align:center" class="text-center"><u>{{trans('localize.GST_summary')}}</u></td>
                    <th style="padding-left:5px;text-align:center" class="text-center"><u>@lang('localize.amount') ({{ $order->currency }})</u></td>
                    <th style="padding-left:5px;text-align:center" class="text-center"><u>@lang('localize.tax') ({{ $order->currency }})</u></td>
                    <td colspan='2' width="30%"></td>
                </tr>
                <tr>
                    <th style="padding-left:5px;font-weight: normal;text-align:center" class="text-center">{{trans('localize.sr')}}</td>
                    <th style="padding-left:5px;font-weight: normal;text-align:center" class="text-center">{{ number_format($amount, 2) }}</td>
                    <th style="padding-left:5px;font-weight: normal;text-align:center" class="text-center">{{ number_format($tax, 2)}}</td>
                    <td colspan='2' width="30%"></td>
                </tr>
            </table>
            @endif
            ...
            <table style="width: 100%;">
                <tr>
                    ...
                    <td style="margin-top:5%;width:28.5%;margin-left:20.5%">
                        <div style="border: 1px solid black">
                            <br/>
                            <b style="padding-left:10px">@lang('localize.invoice_no')  :</b> OFA{{ $order->tax_inv_no }}<br>
                            <b style="padding-left:10px">@lang('localize.date')        :</b> {{ date_format($order->created_at, 'd/m/Y') }}<br>
                            <b style="padding-left:10px">@lang('localize.Page')        :</b> 1<br>
                            <br/>
                        </div>
        ...
        <div class="col-xs-12">
             <table border=1 width="100%" style="border: 1px solid;border-collapse: collapse;">
                <tr style="border: 1px solid;">
                    <th colspan='3' class='text-center' style="text-align:center;border: 1px solid;"><b>{{trans('localize.description')}}</b></th>
                    <td colspan='2' class='text-center' style="text-align:center;border: 1px solid;"><b>@lang('localize.amount') ({{ $order->currency }})</b></td>
                </tr>
                <tr>
                    <th colspan='3' style="border: 1px solid;">&nbsp;</th>
                    <td class='text-center' colspan="2" style="border-left: 1px solid;"></td>
                </tr>
                <tr>
                    <th colspan="3" style="padding-left:5px;font-weight: normal;border: 1px solid;">{{ trans('localize.merchant_admin_fee') }}</td>
                    <td colspan="2" class="text-center" style="text-align:center;border: 1px solid;">{{ number_format($total, 2) }}</td>
                </tr>
                <tr>
                    <th colspan='3' style="border: 1px solid;">&nbsp;</th>
                    <td class='text-center' colspan="2" style="border-left: 1px solid;"></td>
                ...
                <tr>
                <th colspan='3' style="padding-left:5px;font-weight: normal;border: 1px solid;">@lang('localize.merchant_invoice_no') : {{$order->inv_no}}</th>
                <td class='text-center' colspan="2" style="border: 1px solid;"></td>
                </tr>
                <tr>
                    <th colspan='3' style="border: 1px solid;">&nbsp;</th>
                ...
                <tr>
                    <th colspan='3' style="padding-left:5px;border: 1px solid;">@lang('localize.grand_total') (@lang('localize.including_gst')) </th>
                    <td class='text-center' colspan="2" style="text-align:center;border: 1px solid;"><b>{{ number_format($total, 2) }}</b></td>
                </tr>
            </table>
            <br>
            <br>
            ...
            <table width="70%">
                ...
                <tr>
                    <th class="text-center" style="padding-left:5px;font-weight: normal;text-align:center">{{trans('localize.sr')}}</td>
                    <th class="text-center" style="padding-left:5px;font-weight: normal;text-align:center">{{ number_format($amount, 2) }}</td>
                    <th class="text-center" style="padding-left:5px;font-weight: normal;text-align:center">{{ number_format($tax, 2) }}</td>
                    <td colspan='2' width="30%"></td>
                </tr>
            </table>
            @endif
