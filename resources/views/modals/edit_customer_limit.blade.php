...
<div class="modal-body">
    <form class="form-horizontal" id="submit_form" action="{{ url('admin/customer/limit/action/edit', [$customer_id, $action_id]) }}" method="post">
         {{csrf_field()}}
        ...
        @if($action->type != 1)
        <div class="form-group">
            <label>@lang('localize.number_of_transaction')</label>
        ...
        <button type="button" id="edit-submit-btn" class="btn btn-default btn-success btn-block">@lang('localize.submit')</button>
    </form>
</div>
