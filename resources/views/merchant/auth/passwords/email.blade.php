...
<div class="page-title">
    <a href="{{ url('merchant/login') }}" class="back transition"><i class="fa fa-angle-left"></i></a>
    Forget Password
</div>
<div class="ContentWrapper">
    ...
    <div class="panel-general">
        ...
        <div class="form-general">
            <form role="form" method="POST" action="{{ url('merchant/password/email') }}">
                {{ csrf_field() }}
            ...
            <a  href="{{ url('merchant/login') }}" class="btn btn-link btn-block ">@lang('localize.back')</a>
        </div>
    </div>
</div>
@endsection
