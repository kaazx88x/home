...
<div class="ContentWrapper">
    ...
    <div class="panel-general panel-login active">
        <h4 class="panel-title">@lang('localize.store_login')</h4>

        <div class="login-selection">
            <a href="/merchant/login" class="">@lang('localize.login_as_merchant')</a>
            <a href="/store/login" class="active">@lang('localize.login_as_store_user')</a>
        </div>
        ...
        <div class="form-general">
            ...
            <a href="{{ url('store/password/reset') }}" class="btn btn-link btn-block ">@lang('localize.forgot')</a>
        </div>
    </div>
</div>
@endsection
