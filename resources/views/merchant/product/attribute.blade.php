...
<div class="wrapper wrapper-content animated fadeInRight">
    ...
    <div class="row">
        <div class="tabs-container">
            ...
            @include('merchant.product.nav-tabs', ['link' => 'attribute'])
                                ...
                                <div class="ibox float-e-margins well">
                                   <div class="ibox-title">
                                    ...
                                    <div class="ibox-content">
                                        <div class="row">
                                            <form class="form-horizontal" action="{{ url($route.'/product/attribute', [$pro_id, 'add']) }}" method="POST">
                                            {{ csrf_field() }}
                                                <div class="form-group">
                                                    <label class="col-sm-2 control-label">@lang('localize.attribute')</label>
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" placeholder="@lang('localize.attribute_hint_en')" name="attribute" value="{{ old('attribute') }}">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-2 control-label">@lang('localize.attribute_item')</label>
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" placeholder="@lang('localize.attribute_item_hint_en')" name="attribute_item" value="{{ old('attribute_item') }}">
                                                    </div>
                                                </div>
                                                <div class="ibox-title">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-sm-2 control-label">@lang('localize.attribute')</label>
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" placeholder="@lang('localize.attribute_hint_cn')" name="attribute_cn" value="{{ old('attribute') }}">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-2 control-label">@lang('localize.attribute_item')</label>
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" placeholder="@lang('localize.attribute_item_hint_cn')" name="attribute_item_cn" value="{{ old('attribute_item') }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <label class="col-sm-2 control-label">@lang('localize.attribute')</label>
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" placeholder="@lang('localize.attribute_item_hint_cnt')" name="attribute_cnt" value="{{ old('attribute') }}">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-2 control-label">@lang('localize.attribute_item')</label>
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" placeholder="@lang('localize.attribute_item_hint_cnt')" name="attribute_item_cnt" value="{{ old('attribute_item') }}">
                                                    </div>
                                                </div>
