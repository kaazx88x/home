...
<div class="wrapper wrapper-content animated fadeInRight">
    ...
    <div class="row">
        <div class="tabs-container">
            ...
            @include('merchant.product.nav-tabs', ['link' => 'edit'])

            <div class="tab-content">
                <div class="tab-pane active">
                    <div class="panel-body">

                        <form class="form" id="mer_edit_product" action="{{ url($route . '/product/edit', [$product['details']->pro_id]) }}" method="POST" enctype="multipart/form-data">
                        {{ csrf_field() }}

                        <div class="row">

                            <div class="col-lg-3 col-lg-offset-9">
                                <button type="button" class="btn btn-block btn-primary btn-submit">@lang('localize.update')</button><br>
                            </div>
                                    ...
                                    <div class="panel panel-default">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label">@lang('localize.status')</label>
                                            ...
                                            <div class="form-group">
                                                ...
                                                @else
                                                <span class="pull-left text-center" style="color:red; font-size:16px;">@lang('localize.You_dont_have_any_online_store_to_proceed')</span>
                                                @endif
                                            </div>

                                            <div class="form-group">
                                                <label class="control-label">@lang('localize.product_tittle_english')<span style="color:red;">*</span></label>
                                                <input type="text" placeholder="@lang('localize.product_tittle_english')" class="form-control compulsary" id="pro_title_en" name='pro_title_en' value="{{ old('pro_title_en', $product['details']->pro_title_en) }}">
                                            </div>

                                            <div class="form-group">
                                                <label class="control-label">@lang('localize.product_tittle_chinese')</label>
                                                <input type="text" placeholder="@lang('localize.product_tittle_chinese')" class="form-control" name='pro_title_cn' value="{{ old('pro_title_cn', $product['details']->pro_title_cn) }}">
                                            </div>

                                            <div class="form-group">
                                                <label class="control-label">@lang('localize.product_tittle_chinese_traditional')</label>
                                                <input type="text" placeholder="@lang('localize.product_tittle_chinese_traditional')" class="form-control" name='pro_title_cnt' value="{{ old('pro_title_cnt', $product['details']->pro_title_cnt) }}">
                                            </div>

                                            <div class="form-group">
                                                <label class="control-label">@lang('localize.product_tittle_bahasa')</label>
                                                <input type="text" placeholder="@lang('localize.product_tittle_bahasa')" class="form-control" name='pro_title_my' value="{{ old('pro_title_my', $product['details']->pro_title_my) }}">
                                            </div>
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="@lang('localize.mer_meta_keyword')" name='metakeyword' id='metakeyword' value="{{ old('metakeyword', $product['details']->pro_mkeywords) }}">
                                            </div>

                                            <div class="form-group">
                                                <label class="control-label">@lang('localize.mer_meta_description')</label>
                                                <textarea type="text" class="form-control text-noresize" rows="8" placeholder="@lang('localize.mer_meta_description')" name='metadescription' id='metadescription'>{!! old('metadescription', $product['details']->pro_mdesc) !!}</textarea>
                                            </div>
                                    ...
                                    <div class="panel panel-default">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <p class="form-control-static">
                                                    {{ !$product['details']->limit_enabled? trans('localize.no') : trans('localize.yes') }}
                                                    {{-- <label>
                                            ...
                                            <div class="limit-enable-div {{ old('limit_enabled', $product['details']->limit_enabled)? 'show' : 'hide' }}">
                                                <div class="form-group">
                                                    ...
                                                    <p class="form-control-static">
                                                        {{ $product['details']->limit_quantity }}
                                                    </p>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <p class="form-control-static">
                                                        {{ $limit_types[$product['details']->limit_type] }}
                        ...
                        <div class="row">
                            <div class="col-lg-3 pull-right">
                                <button type="button" class="btn btn-block btn-primary btn-submit">@lang('localize.update')</button>
                            </div>
                            <div class="col-lg-3 pull-right">
                                <button type="button" onclick="reset()" class="btn btn-block btn-default">@lang('localize.reset')</button>
                            </div>
                        </div>
...
$(document).ready(function() {
    ...
    $('.btn-submit').click(function(event) {
        ...
        if(pass) $("#mer_edit_product").submit();
    });
});
