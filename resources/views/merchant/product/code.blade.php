...
<div class="wrapper wrapper-content animated fadeInRight">
    ...
    <div class="row">
        <div class="tabs-container">
            ...
            @include('merchant.product.nav-tabs', ['link' => 'ecard'])
                    ...
                    <div class="panel-body">
                        <div class="row" style="margin-bottom:20px;">
                            <div class="form-upload" style="display:none;">
                                <form action="{{ url( $route . '/product/code/upload', [$product['details']->pro_id]) }}" method="POST" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                    <div class="col-lg-8">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-middle">
                                                    ...
                                                    @elseif($code->status == 1)
                                                        ...
                                                        {{--  <br><br>
                                                        <button type="button" class="btn btn-success btn-xs btn-block btn-redeem" url="{{ url( $route . '/product/code/redeem', [$code->id, $product['details']->pro_id]) }}">
